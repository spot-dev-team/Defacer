...
IXI_DIR = "/home/andresousa615/defacer/IXI_Cluster"
NEW_MODEL_NAME = 'modelo_t4.h5'
BATCH_SIZE = 1
EPOCHS = 60    
LEARNING_RATE = 1e-4
...
class DataGenerator(tf.keras.utils.Sequence):
    ...
    def robust_resize(self, volume, order=1):
        ...
        # --- CORREÇÃO: REMOVIDA A NORMALIZAÇÃO DAQUI ---
        # Apenas calculamos os fatores de zoom e aplicamos o resize
    ...
    def remap_labels(self, mask):
        # Mapeamento igual ao teu script antigo (t2)
    ...
    def __data_generation(self, list_ids_temp):
        ...
        for i, ID in enumerate(list_ids_temp):
            ...
            # Resize (Agora seguro, sem normalizar a máscara)
            ...
            # --- CORREÇÃO: Normalização da Imagem AQUI (No fim, como no código antigo) ---
